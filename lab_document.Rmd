...
```{r}
# todo add west region to the rbind statement
all_regions_afinn = rbind(midwest_afinn %>% mutate(region='midwest'), east_afinn %>% mutate(region='east'))
...
newspapers <- c("NewYorkTimes", "PittsburghGazette", "TelegraphHerald", "DailyOklahoman")
...
tf_idf_text <- tibble(newspapers,text=t(tibble(east_1_bag, east_2_bag, midwest_1_bag, midwest_2_bag,.name_repair = "universal")))
